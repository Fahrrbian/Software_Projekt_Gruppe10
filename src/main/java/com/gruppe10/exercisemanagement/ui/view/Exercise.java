...
@Route("create-exercisess") // Korrigierter Routenname
public class Exercise extends Div {
    ...
    @Autowired
    public Exercise(FreetextExerciseService freetextExerciseService, SingleChoiceService singlechoiceService, MultipleChoiceService multipleChoiceService) {
